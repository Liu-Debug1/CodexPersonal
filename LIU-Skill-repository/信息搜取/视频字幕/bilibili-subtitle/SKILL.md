...
description: Extract Bilibili subtitles with BBDown and render transcript outputs. Use when the user provides a Bilibili URL, BV ID, or av ID and wants subtitles, transcripts, SRT/VTT files, or structured text for downstream summarization.
version: 0.2.0
metadata:
  source: https://github.com/HamsteRider-m/bilibili-subtitle
